...
const InputWithIcon = ({ type, name, placeholder, customClass, value, onChange }) => {
    ...
    return (
        <div className="relative mt-1 rounded-md shadow-sm">
            <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                ...
                {(name === "first_name" || name === "last_name") && <UserIcon className="h-6 w-6 text-gray-500" aria-hidden="true" />}
